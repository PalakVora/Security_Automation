...
class Variables(object):
    ...
    @staticmethod
    def check_variables():
        Variables.uuid = get_variable("e8bf5f42-773b-491e-a8ef-5b45822f7eb7", default=None)
        ...
        Variables.launch_id = get_variable("e8bf5f42-773b-491e-a8ef-5b45822f7eb7", default=None)
